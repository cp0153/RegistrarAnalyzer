...
list='algorithms assembly arch cp1 cp2 cp3 cp4 foundations os opl ai compiler cg2 cg1 cvcybercrime dc1 dc2 datamining db1 db2 gui1 gui2 ml mobileapp2 mobilerobotics1 mobilerobotics2 nlp selected se1 se2special'
for i in $list; do
